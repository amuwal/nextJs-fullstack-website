          ...
          <div className="border p-4 rounded">
            <input
              ...
              className={`border rounded p-2 w-full mb-2 ${
                validationError && !newExperience.start.trim() ? 'border-red-500' : ''
              }`}
            />
            ...
            <input
              ...
              className={`border rounded p-2 w-full mb-2 ${
                validationError && !newExperience.end.trim() ? 'border-red-500' : ''
              }`}
            />
            ...
            <input
              ...
              className={`border rounded p-2 w-full mb-2 ${
                validationError && !newExperience.role.trim() ? 'border-red-500' : ''
              }`}
            />
            ...
            <input
              ...
              className={`border rounded p-2 w-full mb-2 ${
                validationError && !newExperience.organization.trim() ? 'border-red-500' : ''
              }`}
            />
            ...
            <input
              ...
              className={`border rounded p-2 w-full mb-2 ${
                validationError && !newExperience.jobTitle.trim() ? 'border-red-500' : ''
              }`}
            />
